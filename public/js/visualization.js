...
function getigshit(sorted) { 
  $('#chart').empty();  
  showProgress();
  //get json object which contains media counts
  d3.json('/igMediaCounts', function(error, data) {
    var tip = d3.tip().attr('class', 'd3-tip').html(function(d) { return 'Media Counts : ' + d.counts.media });
    ...
    svg.selectAll(".bar")
      .data(sorted ? data.users.sort(function(a, b) { return a.counts.media - b.counts.media }) : data.users)
      .enter().append("rect")
      .attr("class", "bar")
